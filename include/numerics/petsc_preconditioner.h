...
public:
  ...
  /**
   * Builds and tells PETSc to use any auxiliary data needed by hypre preconditioners such as ams or ads.
   */
  static void set_petsc_hypre_aux_data (PC & pc, System * sys);
#endif
