...
inline short sign(const Point p, const Point q)
{
  return p > q ? 1 : -1;
}
          ...
          case TET14:
            {
              ...
              switch(i)
                ...
                case 12:
                  {
                    std::array<Point, 3> arr = {elem->point(0), elem->point(2), elem->point(1)};
                    return sign((orientation(arr))) * RealGradient(8.0*y*(-x-2.0*y-2.0*z+2.0),  
                                                                   8.0*x*(x+2.0*y+z-1.0),  
                                                                   8.0*x*y);
                  }
                ...
                case 13:
                  {
                    std::array<Point, 3> arr = {elem->point(0), elem->point(2), elem->point(1)};
                    return sign((orientation(arr))) * RealGradient(8.0*y*(2.0*x+y+z-1.0),  
                                                                   8.0*x*(-2.0*x-y-2.0*z+2.0),  
                                                                   8.0*x*y);
                  }
                ...
                case 14:
                  {
                    std::array<Point, 3> arr = {elem->point(0), elem->point(1), elem->point(3)};
                    return sign((orientation(arr))) * RealGradient(8.0*z*(-x-2.0*y-2.0*z+2.0),  
                                                                   8.0*x*z,  
                                                                   8.0*x*(x+y+2.0*z-1.0));
                  }
                ...
                case 15:
                  {
                    std::array<Point, 3> arr = {elem->point(0), elem->point(1), elem->point(3)};
                    return sign((orientation(arr))) * RealGradient(8.0*z*(2.0*x+y+z-1.0),  
                                                                   8.0*x*z,  
                                                                   8.0*x*(-2.0*x-2.0*y-z+2.0));
                  }

                case 16:
                  {
                    std::array<Point, 3> arr = {elem->point(1), elem->point(2), elem->point(3)};
                    return sign((orientation(arr))) * RealGradient(-8.0*y*z,  
                                                                   16.0*x*z,  
                                                                   -8.0*x*y);
                  }
                ...
                case 0:
                  {
                    switch(i)
                      ...
                      case 12:
                        {
                          std::array<Point, 3> arr = {elem->point(0), elem->point(2), elem->point(1)};
                          return sign((orientation(arr))) * RealGradient(-8.0*y,  
                                                                          8.0*(2.0*x+2.0*y+z-1.0),  
                                                                          8.0*y);
                        }
                      ...
                      case 14:
                        {
                          std::array<Point, 3> arr = {elem->point(0), elem->point(1), elem->point(3)};
                          return sign((orientation(arr))) * RealGradient(-8.0*z,  
                                                                          8.0*z,  
                                                                          8.0*(2.0*x+y+2.0*z-1));
                        }
                ...
                case 1:
                  {
                    switch(i)
                      ...
                      case 12:
                        {
                          std::array<Point, 3> arr = {elem->point(0), elem->point(2), elem->point(1)};
                          return sign((orientation(arr))) * RealGradient(8.0*(-x-4.0*y-2.0*z+2.0),  
                                                                        16.0*x,  
                                                                         8.0*x);
                        }
                      ...
                      case 13:
                        {
                          std::array<Point, 3> arr = {elem->point(0), elem->point(2), elem->point(1)};
                          return sign((orientation(arr))) * RealGradient(8.0*(2.0*x+2.0*y+z-1.0),  
                                                                        -8.0*x,  
                                                                         8.0*x);
                        }
                ...
                case 2:
                  {
                    switch(i)
                      ...
                      case 14:
                        {
                          std::array<Point, 3> arr = {elem->point(0), elem->point(1), elem->point(3)};
                          return sign((orientation(arr))) * RealGradient(8.0*(-x-2.0*y-4.0*z+2.0),  
                                                                         8.0*x,  
                                                                        16.0*x);
                        }
                      ...
                      case 15:
                        {
                          std::array<Point, 3> arr = {elem->point(0), elem->point(1), elem->point(3)};
                          return sign((orientation(arr))) * RealGradient(8.0*(2.0*x+y+2.0*z-1.0),  
                                                                        8.0*x,  
                                                                       -8.0*x);
                        }
